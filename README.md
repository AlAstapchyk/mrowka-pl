...
- **End-to-End Testing**: Includes a robust **Playwright** test suite using the Page Object Model (POM) pattern to automatically verify critical user flows like searching and pagination.
  - Run tests with: `npm run test:e2e`
- **GitHub Actions**: A fully configured CI/CD pipeline automatically runs all tests on every push to ensure code stability.
